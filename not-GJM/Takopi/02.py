...
from vstools import initialize_clip, depth, finalize_clip, replace_ranges, set_output as o
...
CR = mux.src_file("/home/c0mp/Downloads/Takopis.Original.Sin.S01E02.Takopis.Salvation.1080p.CR.WEB-DL.JPN.AAC2.0.H.264.MSubs-ToonsHub.mkv", idx=core.bs.VideoSource)
cr = initialize_clip(CR.src)[120:]

AMZN = mux.src_file("/home/c0mp/Downloads/Takopis.Original.Sin.S01E02.Takopis.Salvation.1080p.AMZN.WEB-DL.DDP2.0.H.264-VARYG.mkv", idx=core.bs.VideoSource)
...
bm = bm3d(deblock, ref=mv, sigma=0.65, radius=1)

aa = based_aa(bm, mask_thr=55, alpha=0.15, beta=0.225)

dh = fine_dehalo(aa, rx=2, highsens=40, thmi=42)

deband = replace_ranges(placebo_deband(dh, thr=1.9, radius=16), f3k_deband(dh, thr=78), lazy)
